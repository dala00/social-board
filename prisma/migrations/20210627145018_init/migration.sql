...
CREATE TABLE `User` (
    ...
    UNIQUE INDEX `User.uniqueId_unique`(`uniqueId`),
...
-- AddForeignKey
ALTER TABLE `ApplicationUrl` ADD FOREIGN KEY (`applicationId`) REFERENCES `Application`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
